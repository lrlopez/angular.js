...
describe('input', function() {
  ...
  describe('ng-update-model attributes', function() {
    ...
    it('should trigger only after timeout in text inputs', inject(function($timeout) {
      compileInput('<input type="text" ng-model="name" name="alias" ng-update-model-timeout="10000" />');
    ...
    it('should trigger only after timeout in checkboxes', inject(function($timeout) {
      compileInput('<input type="checkbox" ng-model="checkbox" ng-update-model-timeout="10000" />');
    ...
    it('should allow selecting different timeouts for each event', inject(function($timeout) {
    ...
    it('should allow selecting different timeouts for each event on checkboxes', inject(function($timeout) {
    ...
    it('should inherit model update settings from ancestor elements', inject(function($timeout) {
      var doc = $compile('<form name="test" ng-update-model-on="blur" ng-update-model-timeout="10000">' +
